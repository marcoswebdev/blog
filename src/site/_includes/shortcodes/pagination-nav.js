...
module.exports = eleventyConfig =>
  ...
  eleventyConfig.addShortcode('paginationNav', data => {
    const l10n = data.site[data.locale].pagination;
      ...
      data.pagination.pages.length > 1
        ...
        ${
          ...
          data.pagination.href.previous !== data.pagination.first
            ...
            ${data.pagination.reverse ? `${l10n.next}` : `${l10n.previous}`}</a>`
            : ''
        }
        ...
        ${
          data.pagination.pages.length < 5
            ...
            ${data.page.url === data.pagination.href.first ? 'aria-current="page"' : ''}>${
                l10n.first
              }</a>`
            : ''
        }
        ...
        ${
          data.pagination.pages.length >= 5
            ? data.pagination.pages
              ...
              ${data.page.url === data.pagination.hrefs[index] ? 'aria-current="page"' : ''}>${
                      index + 1
                    }</a>`,
                )
                .join('')
        ...
        ${
          ...
          data.pagination.href.next !== data.pagination.last
            ...
            ${data.pagination.reverse ? `${l10n.previous}` : `${l10n.next}`}</a>`
            : ''
        }
        ...
        <a href="${data.pagination.href.last}"
          ...
          ${data.page.url === data.pagination.href.last ? 'aria-current="page"' : ''}>${
            l10n.last
          }</a>
      </nav>`
        : ''
